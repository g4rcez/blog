...
Typescript faz em runtime, mas dessa vez a nível de tipo (type-level).

# Trabalhando com o `infer`

Para que isso possa ser possível, precisamos entender o conceito de `infer` no Typescript. Ele pode ser um pouco
