...
const LightIcon = (props: React.ComponentPropsWithoutRef<"svg">) => (
...
const DarkIcon = (props: React.ComponentPropsWithoutRef<"svg">) => (
    <svg aria-hidden="true" viewBox="0 0 16 16" {...props}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
const SystemIcon = (props: React.ComponentPropsWithoutRef<"svg">) => (
    <svg aria-hidden="true" viewBox="0 0 16 16" {...props}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
