"use client";
import { CloseOnAutoCompleteNavigation } from "@/components/client/mobile-close-navigation";
...
import React, { forwardRef, Fragment, Suspense, useCallback, useEffect, useId, useRef, useState } from "react";
...
const useAutocomplete = ({ close }: { close: (autocomplete: Autocomplete) => void }) => {
    const id = useId();
