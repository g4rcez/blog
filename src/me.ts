...
export const me: Me = {
  ...
  name: "Allan Garcez",
  aboutBlog: "Aqui você vai encontrar conteúdo sobre frontend em geral, focando em Typescript, React, Tailwindcss, NextJS e mais da sopa de letrinhas do universo frontend.",
  about: "Passionate Frontend Developer with a strong background in developing responsive, user-friendly websites and web applications using ReactJS. Proficient in modern frontend technologies such as Typescript, NextJS, Remix, and TailwindCSS. \n" + "Skilled in working with popular frontend frameworks such as React, React Native, and VueJS. Strong understanding of web development principles, including cross-browser compatibility, SEO, and accessibility.",
